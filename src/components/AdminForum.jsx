	...
	return (
		<form className={"admin-content__form"} method="post" onSubmit={submitForum}>
			...
			<label htmlFor="breed" className="admin-content__form-label">
				Breed:
				<input type="text" className="admin-content__form-input" name="breed" id="breed"></input>
			</label>

			<label htmlFor="location" className="admin-content__form-label">
				Location:
				<input type="text" className="admin-content__form-input" name="location" id="location"></input>
			</label>

			<label htmlFor="short_description" className="admin-content__form-label">
				Short Description:
				<input type="text" className="admin-content__form-input" name="short_description" id="short_description"></input>
			</label>

			<label htmlFor="description" className="admin-content__form-label">
				Long Description:
				<textarea className="admin-content__form-input long-text" name="description" id="description"></textarea>
			</label>

			<p className="admin-content__form-output">{message}</p>

			<button className="admin-content__form-button">Submit New Pet</button>
		</form>
	)
}